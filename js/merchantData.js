...
const MERCHANT_QUIRKS = [
  ...
  "Glances over their shoulder",
  "Checks the door often",
  "Checks the windows often",
  "Counts coins repeatedly",
  ...
  "Starts stories but never finishes them",
  "Corrects other people's grammar",
  "Calls everyone 'friend'",
  "Calls everyone 'boss'",
  "Calls everyone 'chief'",
  "Calls everyone 'kid'",
  "Calls everyone 'my dear'",
  "Gives overly long greetings",
  "Forgets what they were saying",
  "Snaps fingers when remembering something",
  "Writes things down constantly",
  "Keeps checking a notebook",
  "Talks with their hands",
  "Points a lot",
  "Gestures wildly",
  "Nods excessively",
  "Tilts head while listening",
  "Stares uncomfortably long",
  "Avoids eye contact",
  "Blinks rapidly",
  "Squints at people",
  "Leans in conspiratorially",
  "Suddenly changes subject",
  "Whispers secrets loudly",
  "Dramatic gasps",
  "Snorts when laughing",
  "Claps when excited",
  "Rubs their chin thoughtfully",
  "Scratches their beard",
  "Twirls their hair",
  "Tugs on their ear",
  "Rubs their temples",
  "Taps their foot",
  ...
  "Thanks people repeatedly",
  "Asks if everything is alright",
  "Seems perpetually confused",
  "Seems perpetually amused",
  "Laughs at their own jokes",
  "Starts whispering mid-sentence",
  "Lowers voice dramatically",
  "Speaks as if telling a secret",
  "Tries to finish other people's sentences",
  "Repeats questions before answering",
  "Uses strange metaphors",
  "Uses animal comparisons",
  "Uses nautical slang",
  "Uses military slang",
  "Uses arcane jargon",
  "Mishears common words",
  "Pretends to understand things",
  "Corrects themselves mid-sentence",
  "Speaks in half-finished thoughts",
  "Stops mid-word sometimes",
  "Dramatically clears their throat",
  "Peers closely at people",
  "Asks people to repeat themselves",
  "Nods even when confused",
  "Gestures people closer",
  "Waves people away dismissively",
  "Counts silently on fingers",
  "Checks pockets repeatedly",
  "Always adjusting clothing",
  "Always adjusting belt or cloak",
  "Absently polishes something",
  "Idly sharpens a knife",
  "Constantly sipping a drink"
];
